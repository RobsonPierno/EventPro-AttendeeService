...
//	Kafka Consumer ----------------------------------------------------------------------------------------
    ...
    @Bean
    public ConsumerFactory<String, SaleDTO> ticketSaleDoneCF() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SaleDTO> ticketSaleDoneKafkaListener() {
        ConcurrentKafkaListenerContainerFactory<String, SaleDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(this.ticketSaleDoneCF());
        return factory;
    }
